...
import { ShoppingBag, Store, Shield, Zap, Sparkles, TrendingUp, Smartphone, Plus } from 'lucide-react';
    ...
    <div className="relative z-10">
      ...
      <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6">
        ...
        <button
          ...
          className="mt-3 flex w-full items-center justify-center gap-2 rounded-xl border border-dashed border-white/15 bg-white/5 py-2.5 text-sm text-white/50 transition hover:border-white/30 hover:text-white"
        >
          <Plus className="h-4 w-4" /> Proposer un point de rendez-vous
        </button>
      </section>
